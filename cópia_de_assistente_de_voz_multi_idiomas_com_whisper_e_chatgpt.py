...
# Usa o arquivo de áudio fornecido pelo usuário.
...
print(f'Transcrevendo o áudio do arquivo: {record_file}')
...
# 3. Define as variáveis language e record_file
language = 'pt'
record_file = '/content/file_name.mp3'

# 4. Define a variável gemini_api_key
gemini_api_key = 'AIzaSyCqeiQdU5dT5dSJUNjE92N9AqDit98_oMU'

# 5. Configure a variável de ambiente GOOGLE_API_KEY
os.environ['GOOGLE_API_KEY'] = gemini_api_key

# 6. Configure o genai com a chave da API
genai.configure(api_key=gemini_api_key)

# 7. Define a função upload_audio
...
# 8. Chame a função upload_audio
#print(f'Carregando o arquivo de áudio para o Gemini: {record_file}')
uploaded_audio_file = upload_audio(record_file, 'audio/mpeg')
#print(f'Arquivo de áudio carregado: {uploaded_audio_file.name}')

# 9. Inicialize o modelo Gemini para transcrição e conteúdo
model = genai.GenerativeModel('gemini-2.5-flash')

# 10. Transcreva o áudio de entrada
#print(f'Transcrevendo o áudio de entrada com o modelo Gemini...')
response_transcription = model.generate_content([
    "Transcreva este áudio:",
    uploaded_audio_file
])
transcription = response_transcription.text
#print("Transcrição do áudio de entrada:")
#print(transcription)

# 11. Gere a resposta do Gemini usando a transcrição
#print(f'\nGerando resposta com o modelo Gemini para a transcrição: {transcription}')
...
# 13. Salve o áudio gerado pelo gTTS
response_audio = "/content/response_audio.wav"
gtts_object.save(response_audio)

# A reprodução do áudio foi removida conforme sua solicitação.
# print("Áudio da resposta do Gemini sintetizado e reproduzido.")

# 15. Transcreva o áudio gerado pelo gTTS de volta para texto usando o Gemini
#print(f'\nTranscrevendo o áudio da resposta do Gemini para verificação...')
